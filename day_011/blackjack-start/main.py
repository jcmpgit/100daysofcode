...
def calculate_score(card_list):
    """Calculates the total of a list of cards and returns score"""
...
while input("Do you want to play a game of Blackjack 21 'Y' or 'N'?: ").lower() == "y":
    clear()
    print(logo)
    play_game()
...
# if user_score == 21:
#     print(f"You scored {user_score} you win")
# elif computer_score == 21:
#     print(f"Dealer scored {computer_score} you lose")
# elif user_score > 21:
#     if 11 in user_cards:
#         user_total -= 11
